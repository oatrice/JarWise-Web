...
export default function Dashboard() {
    ...
    return (
        <div className="min-h-screen bg-gray-950 font-sans text-gray-100 selection:bg-blue-500/30 flex">

            {/* Desktop Sidebar (Hidden on Mobile) */}
            <aside className="hidden lg:flex flex-col w-64 h-screen sticky top-0 border-r border-gray-800 bg-gray-950/50 backdrop-blur-xl p-6">
