...
- **การตั้งค่า**: เพิ่มหน้าต่างการตั้งค่า (Settings Overlay) สำหรับการปรับแต่งในอนาคต

### Fixed
- **การนำทาง**: แก้ไขตัวชี้หน้าปัจจุบันในแถบนำทางด้านล่าง (Bottom Navigation) ให้แสดงผลถูกต้อง และเพิ่มแถบนำทางในหน้าที่ขาดไปเพื่อประสบการณ์การใช้งานที่ต่อเนื่อง
- **การแสดงผลข้อมูล**: แก้ไขปัญหาการคลิกที่ตัวเลือกช่วงเวลาของกราฟแล้วส่งผลกระทบต่อส่วนอื่นของหน้าจอ
